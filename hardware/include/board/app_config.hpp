...
constexpr uint32_t kSyncIntervalMs = 20 * 1000;
constexpr uint32_t kUploadRetryIntervalMs = 10 * 1000;
...
constexpr uint32_t kFaceDetectIntervalMs = 500;
constexpr float kFaceRecognitionThreshold = 0.5F;
constexpr uint32_t kFaceRecognitionCooldownMs = 3000;
...
constexpr uint32_t kFaceBoxFeedbackHoldMs = 3000;
